/*
 * FILE : O:\src\pywin32\com\win32comext\mapi\src\PyIMAPIFolder.cpp
 * 
...
}
{
  _arg5 = &temp;
	...
	IMAPIFolder *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"lOOOl:CreateFolder",&_arg0,&_obj1,&_obj2,&_obj3,&_arg4)) 
        return NULL;
{
...
}
{
	if (_obj3==Py_None)
		...
		_arg3 = &temp0;
		if (!PyWinObject_AsIID(_obj3, _arg3))
			return NULL;
	}
}
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->CreateFolder(_arg0,_arg1,_arg2,_arg3,_arg4,_arg5);
...
{
	MAKE_OUTPUT_INTERFACE(_arg5, _resultobj, IID_IMAPIFolder)
}
{
	PyWinObject_FreeTCHAR(_arg1);
}
...
PyObject *PyIMAPIFolder::CreateMessage(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    IID * _arg0;
    ULONG  _arg1;
...

{
  _arg2 = &temp;
	...
	IMAPIFolder *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"Ol:CreateMessage",&_obj0,&_arg1)) 
        return NULL;
{
	if (_obj0==Py_None)
		_arg0 = NULL;
		...
		_arg0 = &temp0;
		if (!PyWinObject_AsIID(_obj0, _arg0))
			return NULL;
	}
}
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->CreateMessage(_arg0,_arg1,_arg2);
...
{
	MAKE_OUTPUT_INTERFACE(_arg2, _resultobj, IID_IMessage)
}
    return _resultobj;
}

PyObject *PyIMAPIFolder::CopyMessages(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    SBinaryArray * _arg0;
    IID * _arg1;
...
}
{
	...
	IMAPIFolder *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"OOOlOl:CopyMessages",&_obj0,&_obj1,&_obj2,&_arg3,&_obj4,&_arg5)) 
        return NULL;
{
	_arg0 = &temp;
	_arg0->lpbin = NULL;
	_arg0->cValues = 0;
	if (!PyMAPIObject_AsSBinaryArray(_obj0, _arg0))
		return NULL;
}
{
	if (_obj1==Py_None)
		...
		_arg1 = &temp0;
		if (!PyWinObject_AsIID(_obj1, _arg1))
			return NULL;
	}
}
{
	if (!PyCom_InterfaceFromPyInstanceOrObject(_obj2, IID_IMAPIFolder, (void **)&_arg2, 0))
		return NULL;
}
{
	if (!PyCom_InterfaceFromPyInstanceOrObject(_obj4, IID_IMAPIProgress, (void **)&_arg4, 1))
		return NULL;
}
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->CopyMessages(_arg0,_arg1,_arg2,_arg3,_arg4,_arg5);

      Py_END_ALLOW_THREADS
      if (FAILED(_result))  {
           {
	PyMAPIObject_FreeSBinaryArray(_arg0);
}
{
	if (_arg2) _arg2->Release();
}
{
	if (_arg4) _arg4->Release();
}
...
PyObject *PyIMAPIFolder::DeleteMessages(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    SBinaryArray * _arg0;
    unsigned long  _arg1;
...

{
	...
	IMAPIFolder *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"OlOl:DeleteMessages",&_obj0,&_arg1,&_obj2,&_arg3)) 
        return NULL;
{
	_arg0 = &temp;
	_arg0->lpbin = NULL;
...
{
	if (!PyCom_InterfaceFromPyInstanceOrObject(_obj2, IID_IMAPIProgress, (void **)&_arg2, 1))
		return NULL;
}
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->DeleteMessages(_arg0,_arg1,_arg2,_arg3);
...
PyObject *PyIMAPIFolder::EmptyFolder(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    ULONG  _arg0;
    IMAPIProgress * _arg1;
...

{
	...
	IMAPIFolder *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"lOl:EmptyFolder",&_arg0,&_obj1,&_arg2)) 
        return NULL;
{
	if (!PyCom_InterfaceFromPyInstanceOrObject(_obj1, IID_IMAPIProgress, (void **)&_arg1, 1))
		return NULL;
}
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->EmptyFolder(_arg0,_arg1,_arg2);
...
static PyMethodDef IMAPIFolderMethods[] = {
	 { "EmptyFolder", PyIMAPIFolder::EmptyFolder, 1 },
	 { "DeleteMessages", PyIMAPIFolder::DeleteMessages, 1 },
	 { "DeleteFolder", PyIMAPIFolder::DeleteFolder, 1 },
	 { "CopyMessages", PyIMAPIFolder::CopyMessages, 1 },
	 { "CreateMessage", PyIMAPIFolder::CreateMessage, 1 },
	 { "CreateFolder", PyIMAPIFolder::CreateFolder, 1 },
	 { "GetLastError", PyIMAPIFolder::GetLastError, 1 },
	 { NULL, NULL }
};
PyComTypeObject PyIMAPIFolder::type("PyIMAPIFolder",	&PyIMAPIContainer::type,
	sizeof(PyIMAPIFolder),
	IMAPIFolderMethods,
	GET_PYCOM_CTOR(PyIMAPIFolder));
