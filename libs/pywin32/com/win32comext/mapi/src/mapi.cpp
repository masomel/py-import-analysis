...
static PyMethodDef mapiMethods[] = {
	 { "HrSetOneProp", PyHrSetOneProp, 1 },
	 { "HrGetOneProp", PyHrGetOneProp, 1 },
...
/* This code only valid if non COM SWIG builds */
  ...
  PyDict_SetItemString(d, "error", PyWinExc_ApiError);
	...
	ADD_IID(PS_ROUTING_SEARCH_KEY);
	 ...
	 PyDict_SetItemString(d,"DEL_FOLDERS", PyInt_FromLong((long) DEL_FOLDERS));
	 PyDict_SetItemString(d,"DEL_MESSAGES", PyInt_FromLong((long) DEL_MESSAGES));
	 PyDict_SetItemString(d,"FOLDER_DIALOG", PyInt_FromLong((long) FOLDER_DIALOG));
	 PyDict_SetItemString(d,"MESSAGE_DIALOG", PyInt_FromLong((long) MESSAGE_DIALOG));
	 PyDict_SetItemString(d,"SHOW_SOFT_DELETES", PyInt_FromLong((long) ((ULONG)0x00000002)));
	 PyDict_SetItemString(d,"DELETE_HARD_DELETE", PyInt_FromLong((long) ((ULONG)0x00000010)));
	 ...
	 PyDict_SetItemString(d,"SOF_UNIQUEFILENAME", PyInt_FromLong((long) SOF_UNIQUEFILENAME));
#if (PY_VERSION_HEX > 0x03000000)
	return m;
#endif
}
