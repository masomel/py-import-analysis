# -*- coding: utf-8 -*-
#
# flufl.bounce documentation build configuration file, created by
...
# built documents.
#
from flufl.bounce import __version__
...
latex_documents = [
  ('README.rst', 'fluflbounce.tex', 'flufl.bounce Documentation',
